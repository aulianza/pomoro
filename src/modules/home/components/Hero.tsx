...
const Hero = () => {
  return (
    <div className='pt-6 pb-8 px-6 space-y-6 h-auto bg-white dark:bg-neutral-800'>
      ...
      <div className='flex items-center justify-between py-4 px-5 bg-neutral-50 dark:bg-neutral-900 border dark:border-neutral-700 rounded-2xl'>
